...
| <img src="assets/cruise-control-1.png" height="40"/> | Cruise control is active – maintains constant speed without pedal input. |
...
We use **LCOV** for test coverage analysis to ensure the reliability and quality of the codebase. Follow the steps below to run the tests:
  ...
  <p><img src="assets/test-coverage.png" alt="Coverage Report" width="1000"/></p>
<p>
